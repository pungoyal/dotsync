...
To check the key before trusting it, run `gpg --show-keys /etc/apt/keyrings/dotsync.asc`. It should print the fingerprint `FD8B DCCB 9FAE 77A7 03F3 7154 3EC2 40F3 0AB4 EE33`, which is also listed in the project's [security policy](https://github.com/pungoyal/dotsync/blob/main/SECURITY.md#signing-keys).
