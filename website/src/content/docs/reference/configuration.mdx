...
| `notifications` | `true` | `false` turns off the background agent's [desktop notifications](/dotsync/guides/background-agent/#logs-and-notifications) on this machine |
